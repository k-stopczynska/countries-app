...
const CountryItem = (props) => {
    ...
    return (
        <li onClick={props.countryCardHandler} className={classes.list__item} id={props.name} key={props.name}>
            <Link to={`/${props.name}`}>
            ...
            <p className={classes.country__desc}>Population: <span>{props.population.toLocaleString('en-US')}</span></p>
